...
if (($_POST) && (isset($_POST['novoVeiculo']))) {
    ...
    $veiculoNew = "INSERT INTO veiculos VALUES (NULL, '$modelo', '$ano', '$cor', '$placa', '$docs', '$ipva', '$licenciamento', '$seguro')";

    $sql_exe = $conn->query($veiculoNew) or die($conn->error);
...
<body>
    ...
    <form id="form" method="POST" action="">
        ...
        <p>
            ...
            <input type="text" name="modelo_veiculo" class="" id="modelo-input" placeholder="Celta 1.4" maxlength="30" oninput="validaModelo()">
        ...
        <p>
            ...
            <input type="text" name="ano_veiculo" class="" id="ano-input" placeholder="2023" maxlength="4" oninput="validaAno()">
        ...
        <p>
            ...
            <input type="text" name="cor_veiculo" class="" id="cor-input" placeholder="Preto" maxlength="15" oninput="validaCor()">
        ...
        <p>
            ...
            <input type="text" name="placa_veiculo" class="" id="placa-input" placeholder="XXX-0000" maxlength="7" oninput="validaPlaca()">
        ...
        <p id="doc-displayIrregular" style="font-weight: bold; color: red;">Irregular</p>
        <p id="doc-displayRegular" style="font-weight: bold; color: green;" hidden>Regular</p>
        <input type="text" name="docs_veiculo" class="" id="docs-input" value="0" hidden>

        <label for="ipva_check">IPVA</label>
        <input type="checkbox" name="ipva_check" id="ipva-check" oninput="validaDoc()">
        <input type="text" name="ipva_value" id="ipva-value" value="0" hidden>

        <label for="licenciamento_check">Licenciamento</label>
        <input type="checkbox" name="licenciamento_check" id="licenciamento-check" oninput="validaDoc()">
        <input type="text" name="licenciamento_value" id="licenciamento-value" value="0" hidden>

        <label for="seguro_check">Seguro</label>
        <input type="checkbox" name="seguro_check" id="seguro-check" oninput="validaDoc()">
        <input type="text" name="seguro_value" id="seguro-value" value="0" hidden>
        </p>


        <button type="submit" name="novoVeiculo">Cadastrar</button>
    </form>
