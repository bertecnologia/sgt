...
if (($_POST) && (isset($_POST['novaEmpresa']))) {
    ...
    $empresaNew = "INSERT INTO empresas VALUES (NULL, '$nome', '$unidade', '$cnpj', '$estado', '$cidade', '$cep', '$bairro', '$endereco', '$numero', '$complemento')";

    $sql_exe = $conn->query($empresaNew) or die($conn->error);
...
<body>
    ...
    <form id="form" method="POST">
        ...
        <p>
            ...
            <input type="text" name="nome_input" class="" id="nome-input" placeholder="Nome da empresa" maxlength="100" oninput="validaNome()">
        ...
        <p>
            ...
            <input type="text" name="unidade_input" class="" id="unidade-input" placeholder="Unidade Cajamar" maxlength="50" oninput="validaUnidade()">
        ...
        <p>
            ...
            <input type="text" name="cnpj_input" class="cnpj" id="cnpj-input" placeholder="00.000.000/0000-00" maxlength="18" oninput="validaCNPJ()">
        ...
        <p>
            ...
            <input type="text" name="cidade_input" class="" id="cidade-input" placeholder="Cidade" maxlength="30" oninput="validaCidade()">
        ...
        <p>
            ...
            <input type="text" name="bairro_input" class="" id="bairro-input" placeholder="Bairro" maxlength="30" oninput="validaBairro()">
        ...
        <p>
            ...
            <input type="text" name="cep_input" class="cep" id="cep-input" placeholder="00000-000" maxlength="9" oninput="validaCEP()">
        ...
        <p>
            ...
            <input type="text" name="endereco_input" class="" id="endereco-input" placeholder="Av. Principal" maxlength="50" oninput="validaEndereco()">
        ...
        <p>
            ...
            <input type="text" name="num_input" class="" id="numero-input" placeholder="000" maxlength="4" oninput="validaNumero()">
        ...
        <p>
            ...
            <input type="text" name="complemento_input" class="" id="complemento-input" placeholder="Apto. 00" maxlength="100">
        </p>


        <button type="submit" name="novaEmpresa">Cadastrar</button>
    </form>
