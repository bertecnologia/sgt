...
if (isset($id)) {
    ...
    $emailV = $funcionario['email_funcionario'];
    $celularV = $funcionario['celular_funcionario'];
    $rgV = $funcionario['rg_funcionario'];
    $cpfV = $funcionario['cpf_funcionario'];
    $cnpjV = $funcionario['cnpj_funcionario'];
    $nascV = $funcionario['nascimento_funcionario'];
    $estadoV = $funcionario['estado_funcionario'];
    $cidadeV = $funcionario['cidade_funcionario'];
    $bairroV = $funcionario['bairro_funcionario'];
    $cepV = $funcionario['cep_funcionario'];
    $enderecoV = $funcionario['endereco_funcionario'];
    $numeroV = $funcionario['numero_funcionario'];
    $complementoV = $funcionario['complemento_funcionario'];
    $cargoV = $funcionario['cargo_funcionario'];
    $areaV = $funcionario['area_funcionario'];
    $observacoesV = $funcionario['observacoes_funcionario'];
    ...
    $nascDia = substr($nascV, 8, 2);
    $nascMes = substr($nascV, 5, 2);
    $nascAno = substr($nascV, 0, 4);
    $nascimento = "$nascDia$nascMes$nascAno";

    //Seleciona o nome do estado
    $estado = "";
    switch ($estadoV) {
        case "AC":
            $estadoNome = "Acre";
    ...
    //Se complemento for vazio
    $complemento = "";
    if ($complementoV != "-") {
        $complemento = $complementoV;
    }

    //Se observções for vazio
    $observacoes = "";
    if ($observacoesV != "-") {
...
if (($_POST) && (isset($_POST['updateFuncionario']))) {
    ...
    $funcionarioUpdate = "UPDATE funcionarios SET
        ...
        area_funcionario = '$area',
        observacoes_funcionario = '$observacoes'
        WHERE id_funcionario = '$id'";

    $sql_exe = $conn->query($funcionarioUpdate) or die($conn->error);
...
<body>
    ...
    <h1>Editar Funcionário - B&R</h1>

    <form id="form" method="POST">

        <p>
            <label for="nome_input">Nome:</label>
            <input type="text" name="nome_input" class="" id="nome-input" placeholder="Nome" maxlength="15" oninput="validaNome()" value="<?php echo $nomeV ?>">
        ...
        <p>
            ...
            <input type="text" name="sobrenome_input" class="" id="sobrenome-input" placeholder="Sobrenome" maxlength="50" oninput="validaSobrenome()" value="<?php echo $sobrenomeV ?>">
        ...
        <p>
            ...
            <input type="email" name="email_input" class="" id="email-input" placeholder="exemplo@email.com" maxlength="50" oninput="validaEmail()" value="<?php echo $emailV ?>">
        ...
        <p>
            ...
            <input type="tel" name="cel_input" class="cel" id="cel-input" placeholder="(00) 90000-0000" maxlength="15" oninput="validaCelular()" value="<?php echo $celularV ?>">
        ...
        <p>
            ...
            <input type="text" name="rg_input" class="" id="rg-input" placeholder="00.000.000-0" maxlength="12" oninput="validaRG()" value="<?php echo $rgV ?>">
        ...
        <p>
            ...
            <input type="text" name="cpf_input" class="cpf" id="cpf-input" placeholder="000.000.000-00" maxlength="14" oninput="validaCPF()" value="<?php echo $cpfV ?>">
        ...
        <p>
            ...
            <input type="text" name="cnpj_input" class="cnpj" id="cnpj-input" placeholder="Opcional" maxlength="18" oninput="validaCNPJ()" value="<?php echo $cnpj ?>">
            <span class="alert-message" id="cnpj-span">*CNPJ Inválido!</span>
        </p>

        <p>
            <label for="nascimento_input">Data de Nascimento:</label>
            <input type="text" name="nascimento_input" class="data" id="nascimento-input" placeholder="00/00/0000" maxlength="10" oninput="validaNascimento()" value="<?php echo $nascimento ?>">
        ...
        <p>
            ...
            <input type="text" name="complemento_input" class="" id="complemento-input" placeholder="Apto. 00" maxlength="30" value="<?php echo $complemento ?>">
        </p>
        ...
        <p>
            ...
            <input type="text" name="cargo_usu_input" class="" id="cargo-input" placeholder="Estagiário" maxlength="100" oninput="validaCargo()" value="<?php echo $cargoV ?>">
        ...
        <p>
            ...
            <select name="area_usu_select" id="area-select" oninput="validaArea()" required>
                <option value="<?php echo $areaV ?>"><?php echo $areaV ?></option>
        ...
        <p>
            ...
            <textarea name="observacoes_input" id="observacoes-input" cols="30" rows="4" oninput="validaObservacoes()"><?php echo $observacoes ?></textarea>
            <span class="alert-message" id="observacoes-span">*Contém caracteres inválidos!</span>
        </p>

        <button type="submit" name="updateFuncionario">Salvar</button>
